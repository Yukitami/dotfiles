...
apps.youtube = function ()
    awful.spawn.with_shell("ytdl-mpv")
end
...
apps.night_mode = function ()
    ...
    -- local cmd = "pgrep xsct 0 > /dev/null && (xsct 0 && echo 'OFF') || (echo 'ON' && xsct 3600 &>/dev/null &)"
...
apps.org = function ()
    helpers.run_or_raise({class = 'emacsclient'}, false, "emacs")
end
