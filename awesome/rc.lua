...
local decoration_themes = {
    ...
    "ephemeral",      -- 3 -- Text-generated titlebar
}
...
user = {
    ...
    browser = "flatpak --user run --branch=stable --arch=x86_64 --command=launch-script.sh --file-forwarding app.zen_browser.zen",
    file_manager = "thunar",
    editor = "emacsclient -c  %F",
    --editor = "kitty -1 --class editor -e kak",
    email_client = "kitty -1 --class email -e neomutt",
    music_client = "kitty -o font_size=16 --class music -e ncmpcpp",
    ...
    openweathermap_key = "c4a3f2515c255b3683ee12e8282eaf65"
,
    openweathermap_city_id = "3516091",
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        awful.spawn.with_shell("feh --bg-fill --no-fehbg ~/.local/share/backgrounds/switch.jpg" )
